--HIT COMMAND + A  or CTRL+A to select all text in this script and then paste it into SQL Developer then run it as a script.  You may get errors stating you’re trying to drop an object that doesn’t exist.  You can ignore these.  Make sure your create statements ran and you have data in the tables
  ...
  --The goal here is to drop all possible tables from before
  DROP table member_committees;
  DROP table members_committees;
  DROP table member_comittees;
  DROP table members_comittees;
  DROP table member_commitees;
  DROP table members_commitees;
  DROP TABLE MEMBERS;
  DROP TABLE MEMBER;
  DROP TABLE Committees;
  DROP TABLE Committee;
  DROP TABLE Comittee;
  DROP TABLE Comittees;
  DROP TABLE Commitees;
  DROP TABLE Commitee;
